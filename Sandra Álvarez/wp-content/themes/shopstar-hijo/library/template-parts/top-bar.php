		...
		<div class="padder">
            ...
            <div class="right">
				...
				?>
		            ...
		            <?php } else { ?>
		            	<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php esc_attr_e('Iniciar sesión','shopstar'); ?>"><?php esc_attr_e('Sign In | Regístrate','shopstar'); ?></a>
		            <?php } ?>
		            </div>
                    ...
                    <div class="header-cart">
                        <a class="header-cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e('View your shopping cart', 'shopstar'); ?>">
                            <span class="header-cart-amount">
                                <?php echo sprintf( _n('%d Artículo', '%d Artículo', WC()->cart->get_cart_contents_count(), 'shopstar'), WC()->cart->get_cart_contents_count() );?> - <?php echo wp_kses_data( WC()->cart->get_cart_subtotal() ); ?>
                            </span>
